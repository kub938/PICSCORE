...
function Home() {
  return (
    <>
      <NavBar />
      <div className="relative min-h-screen w-full max-w-[480px] mx-auto pb-[80px]">
        <div className="p-5 bg-gradient-to-b from-white via-white to-pic-primary min-h-screen flex flex-col items-center">
          {/* 프로필 이미지 섹션 */}
